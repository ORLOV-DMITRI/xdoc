        ...
        <>
            <div className={styles.homeContent}>
                ...
                <p className={styles.info}>
                    ...
                    создали этот ресурс, чтобы помочь разработчикам экономить время и усилия, предоставив легкий доступ
                    к
                ...
                <div className={styles.infoList}>
                    ...
                    <ul className={styles.list}>
                        <li className={styles.infoItem}>
                            ...
                            Больше не нужно переписывать код с нуля. Найдите нужный сниппет и вставьте его в свой проект
                            за
                            секунды.
                        </li>
                        <li className={styles.infoItem}>
                            <span>Качество:</span>
                            Все сниппеты проходят проверку нашим сообществом, чтобы вы получали только проверенный и
                            рабочий
                            код.
                        </li>
                        <li className={styles.infoItem}>
                ...
                <div className={styles.subtitle}>
                    Мы рады приветствовать вас в сообществе {logo}! Вместе мы сделаем процесс разработки проще, быстрее
                    и
                    интереснее.
                </div>
